...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'task.update': {
    ...
    key: 'task-completed',
    tenantPath: ['organization', 'offer', 'task'],
    userPath: [],
  },
  'screenshot.create': {
    roles: ['business-owner'],
    key: 'screenshot-uploaded',
    tenantPath: ['organization', 'offer', 'task', 'screenshot'],
    userPath: [],
  },
  'credit.create': {
    roles: ['team-member'],
    key: 'balance-credited',
    tenantPath: ['organization', 'offer', 'task', 'credit'],
    userPath: [],
  },
};
