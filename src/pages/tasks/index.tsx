...
export function TaskListPage(props: TaskListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getTasks({
        relations: ['offer', 'credit.count', 'screenshot.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('offer', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('credit', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'credit',
          header: 'Credit',
          accessorKey: 'credit',
          cell: ({ row: { original: record } }: any) => record?._count?.credit,
        }
      : null,
    hasAccess('screenshot', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'screenshot',
          header: 'Screenshot',
          accessorKey: 'screenshot',
          cell: ({ row: { original: record } }: any) => record?._count?.screenshot,
        }
      : null,
