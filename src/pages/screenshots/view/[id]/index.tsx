...
import { getScreenshotById } from 'apiSdk/screenshots';
import { ScreenshotInterface } from 'interfaces/screenshot';

function ScreenshotViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('screenshot', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/screenshots/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                <FormListItem
                  label="Upload Date"
                  text={data?.upload_date ? format(parseISO(data?.upload_date as unknown as string), 'dd-MM-yyyy') : ''}
                />
