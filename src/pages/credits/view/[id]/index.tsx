...
import { getCreditById } from 'apiSdk/credits';
import { CreditInterface } from 'interfaces/credit';

function CreditViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('credit', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/credits/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                <FormListItem
                  label="Credit Date"
                  text={data?.credit_date ? format(parseISO(data?.credit_date as unknown as string), 'dd-MM-yyyy') : ''}
                />
